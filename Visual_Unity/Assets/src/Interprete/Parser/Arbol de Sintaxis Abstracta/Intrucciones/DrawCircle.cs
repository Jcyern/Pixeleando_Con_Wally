...
namespace ArbolSintaxisAbstracta
{
        ...
        public override object? Evaluate(Evaluator? evaluator = null)
        {
            ...
            if (Wally.Pos.Fila != int.MaxValue)
            {
                ...
                if (rangex && rangey)
                {
                    ...
                    Debug.Log($"Dibujar circulo de {Wally.Pos.Fila},{Wally.Pos.Columna} en dir {x},{y}  en un radio  de {rad}");
                ...
                {
                    Debug.Log("hay direcciones fuera de rango");
                    if (!rangex)
                    {
            ...
            {
                Debug.Log("erorr pq el wally no esta posicionado");
                if (evaluator != null)
                {
    ...
    public class DrawCircleParse : IParse
    {
        ...
        {
            Debug.Log("Parseando DrawCircle");
            ...
            if (parser.Current.type == TypeToken.Coma)
            {
                ...
                if (parser.Current.type == TypeToken.Coma)
                {
                    ...
                    return new DrawCircleNode(circle, distX, distY, radius);
