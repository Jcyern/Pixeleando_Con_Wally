...
namespace ArbolSintaxisAbstracta
{
    ...
    public class DrawRectangleParse : IParse
    {
        ...
        {
            System.Console.WriteLine("Parseando DrawRectangle");
            ...
            if (parser.Current.type == TypeToken.Coma)
            {
                ...
                if (parser.Current.type == TypeToken.Coma)
                {
                    ...
                    {
                        parser.NextToken();
                        System.Console.WriteLine("Hay ancho");
                        var tokens_ancho = new List<Token>();


                        while (parser.Current.type != TypeToken.CloseParenthesis && parser.Current.type != TypeToken.Coma)
                        {
                            System.Console.WriteLine($"Se agrego a ancho{parser.Current}");
                        ...
                        {
                            parser.NextToken();
                            System.Console.WriteLine("Hay altura");
                            ...
                            {
                                System.Console.WriteLine($"Se agrego a altura{parser.Current}");
                        ...
                        {
                            parser.NextToken();
                            System.Console.WriteLine("es un error falta altura   ");
